...
//
//	File name.....: Mystery.c
//	Purpose.......: To show how to debug a program using GDB. This program
//			tries to create the multiplication table for the 
//			numbers entered by the user. But due to a bug in the
//			program, it does not work correctly.
//			Your job, is to find and fix the bug(s).
//
//
//============================================================================
